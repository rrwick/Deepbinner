...
BARCODED_SAMPLES_PER_BARCODED_READ = 4
MIDDLE_SAMPLES_PER_BARCODED_READ = 2
NON_BARCODED_SAMPLES_PER_NON_BARCODED_READ = 4
NON_BARCODED_SAMPLES_FROM_AFTER_END_BARCODE = 2
